  ...
  return (
    <div className="w-full max-w-4xl mt-12">
      ...
      <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-2 rounded-lg" role="alert">
        ...
        <p className="mt-2">Meta: <span className="font-semibold">C$8,300.00</span></p>
        <div className="w-full bg-green-200 rounded-full h-4 mt-2">
          <div className="bg-green-500 h-4 rounded-full" style={{ width: `${Math.min((totalAmount / 8300) * 100, 100)}%` }}></div>
        </div>
        <span className="text-green-700 text-sm">{((totalAmount / 8300) * 100).toFixed(2)}% recaudado</span>
        <p className="text-xs text-gray-600 mt-1">Meta a cumplir al <span className="font-semibold">sábado 4</span></p>
      </div>
